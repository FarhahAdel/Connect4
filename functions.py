...
def is_terminal_node(board):
	return  len(get_valid_locations(board)) == 0# or winning_move(board, player.getPiece()) or winning_move(board, ai.getPiece()) 
...
def minimax_withoutpruning(board, depth, maximizingPlayer):
	...
	if maximizingPlayer:
		...
		for col in valid_locations:
			...
			new_score = minimax_withoutpruning(b_copy, depth-1, False)[1]
			if new_score > value:
				value = new_score
				column = col
		...
		for col in valid_locations:
			...
			new_score = minimax_withoutpruning(b_copy, depth-1, True)[1]
			if new_score < value:
				value = new_score
				column = col
		return column, value
